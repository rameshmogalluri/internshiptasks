  ...
  %>
    ...
    <div class="maindiv">
       ...
       <td>Name</td>
        ...
        <td class="data"><input type="text" value="${sessionScope.user.name}" name="name" id="name"></td>
        </tr>
       <tr>
       <td>Email</td>
        <td class="sessiondata" id="sessionemail">${sessionScope.user.email}</td>
        <td class="data"><input type="email" value="${sessionScope.user.email}" name="email" id="email"></td>
        </tr>  
      <tr>
      <td>Mobile Number</td>
       ...
       <a  href="/logout"> <span> <button type="button" class="btn btn-default">LOGOUT</button></span>  </a> 
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <a href="/delete"><button type="button" class="btn btn-default">YES</button></a>
